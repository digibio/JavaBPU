...
final class InputReportAndHotplugHandler implements Runnable, ISerialComUSBHotPlugListener, IHIDInputReportListener {
    ...
    private final int PRODUCT_VID = 0x1A86; // china arduino
    private final int PRODUCT_PID = 0x7523;
...
//                                    if(
//                                            (usbHidDevicesPresent[x].getVendorID() == PRODUCT_VID) 
//                                            
//                                            && (usbHidDevicesPresent[x].getProductID() == PRODUCT_PID)
//                                            ) {
